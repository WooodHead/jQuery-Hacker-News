  ...
  $.post("/loadStories",{ids:ids},function(data, status){
    if(status=="success"){
      ...
      data.forEach(function(obj){
        ...
        storyNo++;
        htmlAddition+='<div class="row">';
        htmlAddition+='<div class="col-xs-12 title">';
        htmlAddition+=storyNo+". ";
        ...
        htmlAddition+='</div><div class="row sub-row">';
        htmlAddition+='<div  class="subtext col-xs-12">';
